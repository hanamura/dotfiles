...
[_RAISE] = {
  {KC_ESC,  _______,   _______, KC_UP,   _______,  KC_F5,     _______, _______, KC_LPRN, KC_RPRN, _______, _______},
  {_______, PREV_WORD, KC_LEFT, KC_DOWN, KC_RIGHT, NEXT_WORD, _______, _______, KC_LBRC, KC_RBRC, _______, _______},
